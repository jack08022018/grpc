...
import com.example.orchestratorservice.workflow.impl.ReExecuteTransferMoneyWorkflowImpl;
...
public class ReExecuteTransferMoneyWorker {
    ...
    public void createWorker() {
        ...
        var worker =
                workerFactory.newWorker(
                    TaskQueue.RE_EXECUTE_TRANSFER_MONEY_WORKFLOW_TASK_QUEUE.name(), workerOptions);

        // Can be called multiple times
        worker.registerWorkflowImplementationTypes(
                workflowImplementationOptions, ReExecuteTransferMoneyWorkflowImpl.class);
